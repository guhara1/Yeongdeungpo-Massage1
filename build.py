...
<header class="site-header">
  ...
  <div class="header-top">
    <div class="header-inner">
      ...
      <p class="header-tagline"><span class="tag-gem">◆</span> 영등포구 전지역 방문 관리 <span class="tag-gem">◆</span> 24시간 상담</p>
...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <p class="footer-desc">영등포구 전지역 방문 출장마사지·홈타이 안내 사이트입니다. 모든 서비스는 안내된 관리 범위와 위생·안전 기준 안에서만 제공됩니다.</p>
      <address class="footer-contact">
        ...
        <span class="footer-contact-row"><span class="footer-label">서비스 지역</span> 서울특별시 영등포구 전지역</span>
      </address>
    </div>
    <nav class="footer-col" aria-label="서비스 안내">
      <p class="footer-title">서비스</p>
      <ul>
        <li><a href="/massage/">영등포 출장마사지</a></li>
        <li><a href="/seoul/yeongdeungpo-gu/">지역별 안내</a></li>
        <li><a href="/seoul/yeongdeungpo-gu/station/">역세권 안내</a></li>
  ...
  <div class="footer-cta-band">
    <div class="container footer-cta-inner">
      <p class="footer-cta-text">사이트 제작 · 제휴가 필요하신가요? <span>텔레그램으로 빠르게 상담해 드립니다.</span></p>
      <div class="footer-cta-actions">
        <a class="footer-cta-btn" href="{TELEGRAM_URL}" target="_blank" rel="noopener nofollow">웹사이트 제작문의 ↗</a>
        <a class="footer-cta-btn" href="{TELEGRAM_URL}" target="_blank" rel="noopener nofollow">제휴문의 ↗</a>
      </div>
    </div>
  </div>
